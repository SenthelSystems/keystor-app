...
export default function TenantHeader() {
  return (
    <header className="sticky top-0 z-10 border-b border-[#232838] bg-[#0F1115]/95 backdrop-blur">
      <div className="h-[2px] w-full bg-gradient-to-r from-transparent via-[#5B6EE1]/70 to-transparent" />

      <div className="mx-auto max-w-5xl px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3 rounded-xl border border-[#232838] bg-[#141821] px-3 py-2">
          ...
          <div className="hidden md:block text-xs tracking-wide text-zinc-400">
