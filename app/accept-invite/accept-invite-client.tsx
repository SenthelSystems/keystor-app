    ...
    <main className="min-h-screen bg-[#0B0E14] text-zinc-100">
      <div className="mx-auto grid min-h-screen max-w-6xl grid-cols-1 lg:grid-cols-2">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-zinc-300 mt-1">Calm. Control. Confidence.</div>
                </div>
              </div>

              <div className="mt-4 h-[2px] w-full bg-gradient-to-r from-transparent via-[#5B6EE1]/70 to-transparent" />
        ...
        <section className="flex items-center justify-center p-6 lg:p-10">
          <div className="w-full max-w-md rounded-2xl border border-[#232838] bg-[#121726] p-6">
